...
//echo JSSDK::getConfig(); 
?>

<html>
    <head>
        <title>corp demo</title>
    ...
    <script> var _config = <?php echo JSSDK::getConfig();?> </script>
    <script src="http://fastcdn.imoffice.com/js/zepto/1.1.6/zepto.min.js"></script>
    <script src="http://fastcdn.imoffice.com/js/imo-jssdk/imoPC/1.1.0/imoPC.js"></script>
